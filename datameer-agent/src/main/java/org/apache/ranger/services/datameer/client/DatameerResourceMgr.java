...
public class DatameerResourceMgr {

	private static final Logger LOG 	= Logger.getLogger(DatameerResourceMgr.class);
	...
	public static Map<String, Object> connectionTest(String serviceName, Map<String, String> configs) throws Exception {
		...
		try {
			ret = DatameerClient.connectionTest(serviceName, configs);
	...
	public static List<String> getDatameerResources(String serviceName, String serviceType, Map<String, String> configs,ResourceLookupContext context) throws Exception {
		...
		if (serviceName != null && userInput != null) {
			try {
				...
				final DatameerClient datameerClient = new DatameerConnectionMgr().getConnection(serviceName, serviceType, configs);
				if (datameerClient != null) {
					...
					final Callable<List<String>> callableObj = new Callable<List<String>>() {
						...
						public List<String> call() throws Exception {
							return datameerClient.listFiles(finalBaseDir,
									finalWildCardToMatch, pathList);
						}

					};
					if ( callableObj != null) {
						synchronized(datameerClient) {
				...
				LOG.error("Unable to get datameer resources.", e);
				throw e;
			}

		}
		if(LOG.isDebugEnabled()) {
			LOG.debug("<== DatameerResourceMgr.getResources() Result : "+ resultList  );
		}	
		return resultList;
    }
}
