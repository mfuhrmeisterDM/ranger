...
public class DatameerHdfsClient extends BaseClient {

	private static final Log LOG = LogFactory.getLog(DatameerHdfsClient.class);
  private Configuration conf;

	public DatameerHdfsClient(String serviceName, Map<String,String> connectionProperties) {
		super(serviceName,connectionProperties, "datameer-hdfs-client");
	...
	public static final void main(String[] args) {
		...
		if (args.length < 2) {
			System.err.println("USAGE: java " + DatameerHdfsClient.class.getName() + " repositoryName  basedirectory  [filenameToMatch]");
			System.exit(1);
		}
		...
		DatameerHdfsClient fs = new DatameerHdfsClient(repositoryName, new HashMap<String,String>());
    ...
    if (validateConfigsMsg == null) {
		  ...
		  DatameerHdfsClient connectionObj = new DatameerHdfsClient(serviceName, configs);
