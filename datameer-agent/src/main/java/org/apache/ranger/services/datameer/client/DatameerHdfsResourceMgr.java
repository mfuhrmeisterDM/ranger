...
public class DatameerHdfsResourceMgr {

	private static final Logger LOG 	= Logger.getLogger(DatameerHdfsResourceMgr.class);
	...
	public static Map<String, Object> connectionTest(String serviceName, Map<String, String> configs) throws Exception {
		...
		try {
			ret = DatameerHdfsClient.connectionTest(serviceName, configs);
	...
	public static List<String> getHdfsResources(String serviceName, String serviceType, Map<String, String> configs,ResourceLookupContext context) throws Exception {
		...
		if (serviceName != null && userInput != null) {
			try {
				...
				final DatameerHdfsClient hdfsClient = new DatameerHdfsConnectionMgr().getHadoopConnection(serviceName, serviceType, configs);
				if (hdfsClient != null) {
		...
		if(LOG.isDebugEnabled()) {
			LOG.debug("<== DatameerHdfsResourceMgr.getHdfsResources() Result : "+ resultList  );
		}	
		return resultList;
    }
}
