...
/**
 * Direct tests for the {@link RangerDatameerAuthorizer} without going through the HDFS layer.
 *
 */
public class RangerDatameerAuthorizerTest {
    ...
    private static RangerDatameerAuthorizer authorizer;
    ...
    public static void setup() {
        ...
        authorizer = new RangerDatameerAuthorizer();
        authorizer.start();
